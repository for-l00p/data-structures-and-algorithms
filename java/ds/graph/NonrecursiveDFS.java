...
public class NonrecursiveDFS {
     ...
     */
    public NonrecursiveDFS(IntGraph g, int s) {
        ...
        Iterator<Integer>[] adj = (Iterator<Integer>[]) new Iterator[g.numVertices()];
        ...
        while (!stack.isEmpty()) {
            ...
            if (adj[v].hasNext()) {
                ...
                if (!marked[w]) {
                   ...
                   // marked[w] = true;
                    // edgeTo[w] = v;
                   // System.out.println("Neighbour unmarked. Adding to stack: " + w);
                    stack.push(w);
                    // StdOut.printf("dfs(%d)\n", w);
                }
            }
    ...
    public static void main(String[] args) {
        // String in = new In(args[0]);
        // IntGraph g = new IntGraph(in);
