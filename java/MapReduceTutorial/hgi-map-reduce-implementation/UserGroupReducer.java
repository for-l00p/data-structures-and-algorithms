...
public class UserGroupReducer extends MapReduceBase implements Reducer<Text, IntWritable, Text, IntWritable> {
	...
	public void reduce(Text t_key, Iterator<Text> values, OutputCollector<Text,Text> output, Reporter reporter) throws IOException {
		...
		while (values.hasNext()) {
			...
			long iNodeLastModifed = Long.parseLong(iNodeData[5]);
			numInodes++;
			totalSize = totalSize + iNodeSize;
			if (iNodeLastModifed > lastModifed){
				lastModifed = iNodeLastModifed;
			}
		}
		if (lastModifed == 0){
			lastModifed = null;
		}
		String reducedValue = "{" + t_key + ":" + numInodes + ":" + totalSize + ":" + lastModifed + "}";
...
export CLASSPATH="$HADOOP_HOME/share/hadoop/mapreduce/hadoop-mapreduce-client-core-3.1.2.jar:$HADOOP_HOME/share/hadoop/mapreduce/hadoop-mapreduce-client-common-3.1.2.jar:$HADOOP_HOME/share/hadoop/common/hadoop-common-3.1.2.jar: .: ./SalesCountry"
